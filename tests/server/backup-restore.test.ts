...
const RSS = `<?xml version="1.0"?>
  <rss version="2.0"><channel><title>Field Notes</title>
    <item>
      ...
      <description><![CDATA[<p>A <strong>morning</strong> note</p>]]></description><pubDate>Fri, 07 Aug 2026 07:15:00 GMT</pubDate>
    </item>
  </channel></rss>`
...
describe('backup and restore, round-tripped through the running application', () => {
  it('preserves Subscriptions, schedules, retained Feed Items, Library membership, settings, and User access', async () => {
    ...
    expect(reader.feedContent?.markdown).toBe('A **morning** note')
    await service.stop()
    ...
    expect(restoredReader.feedContent).toEqual(reader.feedContent)
