...
/**
 * The boundary belongs to the service, not to whichever module retrieves next.
 * These assertions run through the real composition root and real configuration
 * parsing, so a later ticket cannot quietly wire a Feed poller to a bare client.
 */
